...
<html>
	...
	<body>
		<a href="/<?php echo $root; ?>/PayWeb3/index.php">back to Initiate</a>
		<form action="simple_request.php" method="post" name="paygate_initiate_form">
			...
			<input type="text" name="REFERENCE" id="REFERENCE" value="<?php echo generateReference(); ?>" />
			<br>
			...
			<input type="text" name="RETURN_URL" id="RETURN_URL" value="<?php echo $fullPath['protocol'] . $fullPath['host'] . '/' . $root . '/PayWeb3/result.php'; ?>" />
			<br>
